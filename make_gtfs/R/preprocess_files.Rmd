...
opts_knit$set(root.dir = '/home/dabanto/Downloads/kleine_fg/test_agile/')
```
...
lines <- st_read("make_gtfs/final.gpkg")
...
stops <- st_read("make_gtfs/atu_stops.gpkg")
...
write.csv(freq, "make_gtfs/frequencies.csv", row.names = F)
...
st_write(routes, "make_gtfs/shapes.geojson", driver = "GeoJSON", delete_dsn = TRUE)
...
write.csv(meta, "make_gtfs/meta.csv", row.names = F)
...
write.csv(stops_op, "make_gtfs/stops.csv", row.names = F)
