...
First, we need to run the R Markdown [preprocess_files.Rmd](busability-lima-agile-2025/blob/main/make_gtfs/R/preprocess_files.Rmd). Paste the files "atu_stops.gpkg" and "final_shapes.gpkg" into the make_gtfs_data folder.  
